...
namespace sf::priv
{
class EglContextHarmony : public GlContext
{
public:
    ////////////////////////////////////////////////////////////
    ...
    ///
    ////////////////////////////////////////////////////////////
    EglContextHarmony(EglContextHarmony* shared);
    ...
    ///
    ////////////////////////////////////////////////////////////
    EglContextHarmony(EglContextHarmony* shared, const ContextSettings& settings, Vector2u size);

    ////////////////////////////////////////////////////////////
    /// \brief Destructor
    ///
    ////////////////////////////////////////////////////////////
    ~EglContextHarmony() override;
    ...
    ///
    ////////////////////////////////////////////////////////////
    void createContext(EglContextHarmony* shared, const ContextSettings& settings, unsigned int bitsPerPixel, EGLint surfaceType);
...
private:
    ////////////////////////////////////////////////////////////
    /// \brief Reconcile an asynchronously replaced native surface
    ////////////////////////////////////////////////////////////
    bool validateCurrentContext() override;

    ////////////////////////////////////////////////////////////
    /// \brief Reconcile a Harmony window surface generation
    ////////////////////////////////////////////////////////////
    bool synchronizeHarmonySurface();

    ////////////////////////////////////////////////////////////
    /// \brief Bind the persistent context to a Harmony EGL surface
    ////////////////////////////////////////////////////////////
    bool makeHarmonyCurrent(EGLSurface surface);
    ...
    EGLSurface    m_surface{EGL_NO_SURFACE};         //!< Window surface, or the sole surface for an offscreen context
    ...
    bool          m_verticalSyncDirty{}; //!< Whether the swap interval must be applied to the current surface
};
