...
// Harmony's desktop GL/gl.h exposes the core 1.x prototypes, but unlike the
// GLES headers it does not provide PFNGL*PROC aliases for those entry points.
// Keep the diagnostic loader independent of that header-level difference.
using GlBindTextureFunction = void (*)(GLenum, GLuint);
using GlClearFunction       = void (*)(GLbitfield);
using GlClearColorFunction  = void (*)(GLfloat, GLfloat, GLfloat, GLfloat);
#if defined(SFML_OPENGL_ES)
using GlClearDepthFunction                     = void (*)(GLfloat);
constexpr const char* glClearDepthFunctionName = "glClearDepthf";
#else
using GlClearDepthFunction                     = void (*)(GLdouble);
constexpr const char* glClearDepthFunctionName = "glClearDepth";
#endif
using GlClearStencilFunction = void (*)(GLint);
using GlColorMaskFunction    = void (*)(GLboolean, GLboolean, GLboolean, GLboolean);
using GlDepthFuncFunction    = void (*)(GLenum);
using GlDepthMaskFunction    = void (*)(GLboolean);
using GlDisableFunction      = void (*)(GLenum);
using GlDrawArraysFunction   = void (*)(GLenum, GLint, GLsizei);
using GlEnableFunction       = void (*)(GLenum);
using GlGetBooleanFunction   = void (*)(GLenum, GLboolean*);
using GlGetErrorFunction     = GLenum (*)();
using GlGetFloatFunction     = void (*)(GLenum, GLfloat*);
using GlGetIntegerFunction   = void (*)(GLenum, GLint*);
using GlIsEnabledFunction    = GLboolean (*)(GLenum);
using GlScissorFunction      = void (*)(GLint, GLint, GLsizei, GLsizei);
using GlViewportFunction     = void (*)(GLint, GLint, GLsizei, GLsizei);

struct RawStateGl
{
    PFNGLACTIVETEXTUREPROC            activeTexture{};
    PFNGLBINDBUFFERPROC               bindBuffer{};
    GlBindTextureFunction             bindTexture{};
    GlClearColorFunction              clearColor{};
    GlClearStencilFunction            clearStencil{};
    GlColorMaskFunction               colorMask{};
    GlDisableFunction                 disable{};
    PFNGLDISABLEVERTEXATTRIBARRAYPROC disableVertexAttribArray{};
    GlEnableFunction                  enable{};
    GlGetBooleanFunction              getBoolean{};
    GlGetFloatFunction                getFloat{};
    GlGetIntegerFunction              getInteger{};
    PFNGLGETVERTEXATTRIBIVPROC        getVertexAttribInteger{};
    GlIsEnabledFunction               isEnabled{};
    GlScissorFunction                 scissor{};
    PFNGLUSEPROGRAMPROC               useProgram{};
    GlViewportFunction                viewport{};
...
const RawStateGl& getRawStateGl()
{
    static const RawStateGl functions = []
    {
        ...
        result.bindTexture              = loadGlFunction<GlBindTextureFunction>("glBindTexture");
        result.clearColor               = loadGlFunction<GlClearColorFunction>("glClearColor");
        result.clearStencil             = loadGlFunction<GlClearStencilFunction>("glClearStencil");
        result.colorMask                = loadGlFunction<GlColorMaskFunction>("glColorMask");
        result.disable                  = loadGlFunction<GlDisableFunction>("glDisable");
        result.disableVertexAttribArray = loadGlFunction<PFNGLDISABLEVERTEXATTRIBARRAYPROC>(
            "glDisableVertexAttribArray");
        result.enable                 = loadGlFunction<GlEnableFunction>("glEnable");
        result.getBoolean             = loadGlFunction<GlGetBooleanFunction>("glGetBooleanv");
        result.getFloat               = loadGlFunction<GlGetFloatFunction>("glGetFloatv");
        result.getInteger             = loadGlFunction<GlGetIntegerFunction>("glGetIntegerv");
        result.getVertexAttribInteger = loadGlFunction<PFNGLGETVERTEXATTRIBIVPROC>("glGetVertexAttribiv");
        result.isEnabled              = loadGlFunction<GlIsEnabledFunction>("glIsEnabled");
        result.scissor                = loadGlFunction<GlScissorFunction>("glScissor");
        result.useProgram             = loadGlFunction<PFNGLUSEPROGRAMPROC>("glUseProgram");
        result.viewport               = loadGlFunction<GlViewportFunction>("glViewport");
        return result;
    }();
    return functions;
}
...
struct DepthDiagnosticGl
{
    ...
    GlClearFunction                  clear{};
    GlClearColorFunction             clearColor{};
    GlClearDepthFunction             clearDepth{};
    GlColorMaskFunction              colorMask{};
    ...
    GlDepthFuncFunction              depthFunc{};
    GlDepthMaskFunction              depthMask{};
    GlDisableFunction                disable{};
    GlDrawArraysFunction             drawArrays{};
    GlEnableFunction                 enable{};
    PFNGLENABLEVERTEXATTRIBARRAYPROC enableVertexAttribArray{};
    GlGetBooleanFunction             getBoolean{};
    GlGetErrorFunction               getError{};
    GlGetFloatFunction               getFloat{};
    GlGetIntegerFunction             getInteger{};
    ...
    [[nodiscard]] explicit operator bool() const
    {
        return attachShader && bindAttribLocation && bindBuffer && bufferData && checkFramebufferStatus && clear &&
               clearColor && clearDepth && colorMask && compileShader && createProgram && createShader &&
               deleteBuffers && deleteShader && deleteProgram && depthFunc && depthMask && disable && drawArrays &&
               enable && enableVertexAttribArray && genBuffers && getBoolean && getError && getFloat && getInteger &&
               getProgramInteger && getShaderInteger && getUniformLocation && linkProgram && shaderSource &&
               uniform1f && uniform4f && useProgram && vertexAttribPointer && viewport;
    }
};
...
const DepthDiagnosticGl& getDepthDiagnosticGl()
{
    static const DepthDiagnosticGl functions = []
    {
        ...
        result.bindBuffer              = loadGlFunction<PFNGLBINDBUFFERPROC>("glBindBuffer");
        result.bufferData              = loadGlFunction<PFNGLBUFFERDATAPROC>("glBufferData");
        result.checkFramebufferStatus  = loadGlFunction<PFNGLCHECKFRAMEBUFFERSTATUSPROC>("glCheckFramebufferStatus");
        result.clear                   = loadGlFunction<GlClearFunction>("glClear");
        result.clearColor              = loadGlFunction<GlClearColorFunction>("glClearColor");
        result.clearDepth              = loadGlFunction<GlClearDepthFunction>(glClearDepthFunctionName);
        result.colorMask               = loadGlFunction<GlColorMaskFunction>("glColorMask");
        ...
        result.deleteBuffers           = loadGlFunction<PFNGLDELETEBUFFERSPROC>("glDeleteBuffers");
        ...
        result.depthFunc               = loadGlFunction<GlDepthFuncFunction>("glDepthFunc");
        result.depthMask               = loadGlFunction<GlDepthMaskFunction>("glDepthMask");
        result.disable                 = loadGlFunction<GlDisableFunction>("glDisable");
        result.drawArrays              = loadGlFunction<GlDrawArraysFunction>("glDrawArrays");
        result.enable                  = loadGlFunction<GlEnableFunction>("glEnable");
        result.enableVertexAttribArray = loadGlFunction<PFNGLENABLEVERTEXATTRIBARRAYPROC>("glEnableVertexAttribArray");
        result.getBoolean              = loadGlFunction<GlGetBooleanFunction>("glGetBooleanv");
        result.getError                = loadGlFunction<GlGetErrorFunction>("glGetError");
        result.getFloat                = loadGlFunction<GlGetFloatFunction>("glGetFloatv");
        result.getInteger              = loadGlFunction<GlGetIntegerFunction>("glGetIntegerv");
        ...
        result.genBuffers              = loadGlFunction<PFNGLGENBUFFERSPROC>("glGenBuffers");
...
bool checkRenderTextureDepthOperation(sf::RenderTexture& target, sf::Color clearColor)
{
    ...
    if (program)
    {
        ...
        if (depthLocation >= 0 && colorLocation >= 0 && positionBuffer)
        {
            ...
            gl.bufferData(GL_ARRAY_BUFFER, sizeof(positions), positions.data(), GL_STATIC_DRAW);
        ...
        gl.bindBuffer(GL_ARRAY_BUFFER, 0);
        if (positionBuffer)
            gl.deleteBuffers(1, &positionBuffer);
        gl.useProgram(0);
        gl.deleteProgram(program);
    }
...
bool checkRenderTextureStencilOperation(sf::RenderTexture& target, sf::Color clearColor)
{
    ...
    // The preceding depth check deliberately uses raw GL. Re-establish SFML's
    // programmable state before testing a clear followed by stencil drawing.
    ...
    const sf::Image copy     = target.getTexture().copyToImage();
    const sf::Color masked   = copy.getSize() == sf::Vector2u(48, 48) ? copy.getPixel({8, 24}) : sf::Color{};
    const sf::Color unmasked = copy.getSize() == sf::Vector2u(48, 48) ? copy.getPixel({40, 24}) : sf::Color{};
    const bool successful = copy.getSize() == sf::Vector2u(48, 48) && masked == maskedColor && unmasked == clearColor;
    if (!successful)
    {
        std::ostringstream message;
        message << "RenderTexture stencil pixels failed: size=" << copy.getSize().x << 'x' << copy.getSize().y
                << " masked=" << static_cast<unsigned int>(masked.r) << ',' << static_cast<unsigned int>(masked.g)
                << ',' << static_cast<unsigned int>(masked.b) << ',' << static_cast<unsigned int>(masked.a)
                << " unmasked=" << static_cast<unsigned int>(unmasked.r) << ',' << static_cast<unsigned int>(unmasked.g)
                << ',' << static_cast<unsigned int>(unmasked.b) << ',' << static_cast<unsigned int>(unmasked.a);
        logError(message.str());
    }
    return successful;
}
...
RenderTextureDiagnostics checkRenderTextureConfigurations()
{
    ...
    try
    {
        ...
        result.depthOnly    = checkSmallRenderTexture(sf::ContextSettings{24}, sf::Color(30, 40, 50));
        result.stencilOnly  = checkSmallRenderTexture(sf::ContextSettings{0, 8}, sf::Color(40, 50, 60));
        result.depthStencil = checkSmallRenderTexture(sf::ContextSettings{24, 8}, sf::Color(50, 60, 70));
...
#if defined(SFML_HARMONY_2IN1)
            stream << "\nPC: F6 geometry/title/icon  F7 grab  F8 hide/show  F9 fullscreen";
#endif
            break;
...
#if defined(SFML_HARMONY_2IN1)
    bool       pcGeometryAlternate{};
    bool       pcCursorGrabbed{};
    bool       pcFullscreen{};
    const auto applyPcWindowDiagnostics = [&]
    {
        pcGeometryAlternate         = !pcGeometryAlternate;
        const sf::Vector2i position = pcGeometryAlternate ? sf::Vector2i{180, 140} : sf::Vector2i{360, 240};
        const sf::Vector2u size     = pcGeometryAlternate ? sf::Vector2u{1200, 800} : sf::Vector2u{1000, 700};
        window.setMinimumSize(sf::Vector2u{640, 480});
        window.setMaximumSize(sf::Vector2u{2200, 1600});
        window.setPosition(position);
        window.setSize(size);
        window.setTitle(
            pcGeometryAlternate ? "SFML Harmony 2in1 desktop diagnostics" : "SFML Harmony 2in1 alternate geometry");
        if (checkerboard.getSize().x && checkerboard.getSize().y)
            window.setIcon(checkerboard.getSize(), checkerboard.getPixelsPtr());
        window.requestFocus();

        const auto actualPosition = window.getPosition();
        const auto actualSize     = window.getSize();
        logInfo("PC window geometry requested=" + std::to_string(position.x) + ',' + std::to_string(position.y) + ' ' +
                std::to_string(size.x) + 'x' + std::to_string(size.y) + " actual=" + std::to_string(actualPosition.x) +
                ',' + std::to_string(actualPosition.y) + ' ' + std::to_string(actualSize.x) + 'x' +
                std::to_string(actualSize.y));
    };
    const auto togglePcFullscreen = [&]
    {
        try
        {
            pcFullscreen             = !pcFullscreen;
            const sf::VideoMode mode = pcFullscreen ? sf::VideoMode::getDesktopMode() : sf::VideoMode({1200, 800});
            window.create(mode,
                          "SFML Harmony 2in1 diagnostics",
                          sf::Style::Default,
                          pcFullscreen ? sf::State::Fullscreen : sf::State::Windowed,
                          requested);
            window.setVerticalSyncEnabled(true);
            window.setKeyRepeatEnabled(true);
            actualSettings = window.getSettings();
            configureView(window, view);
            pcCursorGrabbed = false;
            if (!pcFullscreen)
                applyPcWindowDiagnostics();
            logInfo(std::string("PC SFML fullscreen toggle ") + (pcFullscreen ? "immersive-maximized" : "floating"));
        } catch (const sf::Exception& exception)
        {
            pcFullscreen = !pcFullscreen;
            logError(std::string("PC fullscreen toggle failed: ") + exception.what());
        }
    };
    applyPcWindowDiagnostics();
#endif
        ...
        while (const std::optional event = window.pollEvent())
        {
            ...
            if (const auto* key = event->getIf<sf::Event::KeyPressed>())
            {
                ...
                else if (key->code == sf::Keyboard::Key::P)
                {
                    ...
                    togglePointerVisibility();
#if defined(SFML_HARMONY_2IN1)
                else if (key->code == sf::Keyboard::Key::F6 && !pcFullscreen)
                    applyPcWindowDiagnostics();
                else if (key->code == sf::Keyboard::Key::F7)
                {
                    pcCursorGrabbed = !pcCursorGrabbed;
                    window.setMouseCursorGrabbed(pcCursorGrabbed);
                    logInfo(std::string("PC cursor grab requested ") + (pcCursorGrabbed ? "on" : "off"));
                }
                else if (key->code == sf::Keyboard::Key::F8)
                {
                    window.setVisible(false);
                    sf::sleep(sf::seconds(1));
                    window.setVisible(true);
                    window.requestFocus();
                    logInfo("PC minimize/restore diagnostic completed");
                }
